...
# Lesson 08 - Wordpress - чудовий засоб для створення нескладного веб-сайту без глибоких знаннь програмування (4)

    Чому саме Wordpress? Бо простий, як двері, безкоштовний, з потужною підтримкою та купою плагінів та віджетів
    Як розгорнути Wordpress на практичному прикладі
    Структура Wordpress-сайту, головна та стрічка новин, локалізація
    Додаємо віджети та компоненти, міняємо тему.
    Створюємо свою тему для розповсюдження.
